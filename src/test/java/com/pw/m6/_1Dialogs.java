...
public class _1Dialogs extends ScriptBase {

    @Test
    public void alertTest() {
        page.navigate(home);
        page.fill("#donation", "50");
        page.onDialog(dialog -> dialog.accept()); // makes no difference, PW dismisses dialog automatically
    ...
    public void confirmTestAccept() {
        ...
        page.onDialog(dialog -> dialog.accept()); // register FIRST!
        page.click("#submit-donation");
