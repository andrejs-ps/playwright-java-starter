...
public class _2ClickFillOptions extends ScriptBase {
    ...
    public void fillOptions() {
        ...
        page.navigate(home);
        page.fill("id=exampleMessage", "So I was thinking the other day...", new Page.FillOptions().setForce(true));
    }
